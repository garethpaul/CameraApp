...
for path in \
  ...
  "trusted-verifier/expected/pr32/README.md" \
  "trusted-verifier/expected/pr32/SECURITY.md" \
  "trusted-verifier/expected/pr32/docs/plans/2026-06-21-cameraapp-make-authority.md" \
  "trusted-verifier/expected/pr32/scripts/check-baseline.sh" \
  "trusted-verifier/expected/pr32/scripts/test-makefile-root.sh" \
...
for trusted_policy_contract in \
  ...
  '"trusted-verifier/expected/pr32/docs/plans/2026-06-21-cameraapp-make-authority.md"' \
  '"trusted-verifier/expected/pr32/scripts/check-baseline.sh"' \
  '"trusted-verifier/expected/pr32/scripts/test-makefile-root.sh"'; do
...
for trusted_test_contract in \
  ...
  'test_environment_api_requests_use_explicit_bearer_token' \
  'test_environment_preflight_rejects_environment_or_app_mismatch' \
  'test_policy_authorizes_only_reviewed_documentation_and_harness_paths' \
