...
- This is a preserved Camera2 sample on AGP 9.2.0 and Gradle 9.6.1. Keep JDK
...
- The opened callback must publish its device and synchronously submit preview
  creation before releasing its transferred semaphore ownership.
